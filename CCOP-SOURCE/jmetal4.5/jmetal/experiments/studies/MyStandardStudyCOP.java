 ...
 */
public class MyStandardStudyCOP extends Experiment {
  ...
  public void algorithmSettings(String problemName, 
    ...
    try {
     ...
     algorithm[3] = new csSPEA2_Settings(problemName).configure(parameters[3]);
      ...
      Logger.getLogger(MyStandardStudyCOP.class.getName()).log(Level.SEVERE, null, ex);
  ...
  public static void main(String[] args) throws JMException, IOException {
	  ...
	  try {
		  ...
		  COPConfigurator.configure(args[0]); 
	  ...
	  MyStandardStudyCOP exp = new MyStandardStudyCOP();
   ...
   // CHECK FORM DOCUMENTATION 
    ...
    exp.experimentBaseDirectory_ = COPConfigurator.baseDir + "/"+
                                   exp.experimentName_;
    ...
    COPConfigurator.distanceStatistics(exp.algorithmNameList_);
