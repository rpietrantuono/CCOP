...
//					if (((Sources)(parent1.getDecisionVariables()[0]))._sourcesList.size() < ((Sources)(parent2.getDecisionVariables()[0]))._sourcesList.size())
			...
			*/		
					...
					crosspoint2 = PseudoRandom.randInt(0,min) ;
				      ...
				      if (sourceListLength1<COPConfigurator.MIN_sources || sourceListLength2<COPConfigurator.MIN_sources)
				...
				*/	
				    while (((Sources)(offspring[0].getDecisionVariables()[0]))._sourcesList.size()<COPConfigurator.MIN_sources) {
				    	String sourceToAdd; 
				    	do {
				    ...
				    while (((Sources)(offspring[1].getDecisionVariables()[0]))._sourcesList.size()<COPConfigurator.MIN_sources) {
				    	String sourceToAdd; 
				    	do {
				    		sourceToAdd = COPConfigurator.possibleSources.get(COPConfigurator.ran.nextInt(COPConfigurator.possibleSources.size()));
				    	}
				    ...
				    ((Targets)(offspring[0].getDecisionVariables()[1]))._targetsList.add(((Targets)(parent1.getDecisionVariables()[1]))._targetsList.get(COPConfigurator.ran.nextInt(((Targets)(parent1.getDecisionVariables()[1]))._targetsList.size()))); 
				    ((Targets)(offspring[1].getDecisionVariables()[1]))._targetsList.add(((Targets)(parent2.getDecisionVariables()[1]))._targetsList.get(COPConfigurator.ran.nextInt(((Targets)(parent1.getDecisionVariables()[1]))._targetsList.size())));
